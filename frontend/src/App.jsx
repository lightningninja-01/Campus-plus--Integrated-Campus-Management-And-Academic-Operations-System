...
export default function App() {
  ...
  // Faculty dashboard — coming next
  return (
    <div style={{ minHeight: "100vh", background: "#0d0e1a", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 12, fontFamily: "DM Sans, sans-serif", color: "#fff" }}>
      <p style={{ fontSize: 22, fontWeight: 700 }}>Welcome, {user.name}! 👋</p>
      <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 14 }}>
        <span style={{ color: "#22c55e", fontWeight: 600 }}>Faculty</span> dashboard coming soon...
      </p>
    </div>
  );
}